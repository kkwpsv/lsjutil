...
namespace Lsj.Util.Win32.Marshals
{
    ...
    [StructLayout(LayoutKind.Explicit, CharSet = CharSet.Unicode)]
    public struct UnionStruct<T1, T2, T3, T4, T5, T6> where T1 : struct where T2 : struct where T3 : struct where T4 : struct where T5 : struct where T6 : struct
    {
        /// <summary>
        /// 
        /// </summary>
    ...
    [StructLayout(LayoutKind.Explicit, CharSet = CharSet.Unicode)]
    public struct UnionStruct<T1, T2, T3, T4, T5, T6, T7> where T1 : struct where T2 : struct where T3 : struct where T4 : struct
    ...
    [StructLayout(LayoutKind.Explicit, CharSet = CharSet.Unicode)]
    public struct UnionStruct<T1, T2, T3, T4, T5, T6, T7, T8> where T1 : struct where T2 : struct where T3 : struct where T4 : struct
