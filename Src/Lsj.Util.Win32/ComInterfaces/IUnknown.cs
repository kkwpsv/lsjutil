...
namespace Lsj.Util.Win32.ComInterfaces
{
    ...
    /// </para>
    /// <para>
    /// From: <see href="https://learn.microsoft.com/en-us/windows/win32/api/unknwn/nn-unknwn-iunknown"/>
    /// </para>
    /// </summary>
    public unsafe struct IUnknown
    {
        ...
        public ULONG AddRef()
        {
            fixed (void* thisPtr = &this)
            {
                return ((delegate* unmanaged[Stdcall]<void*, ULONG>)_vTable[1])(thisPtr);
            }
        }
        ...
        public ULONG Release()
        {
            fixed (void* thisPtr = &this)
            {
                return ((delegate* unmanaged[Stdcall]<void*, ULONG>)_vTable[2])(thisPtr);
            }
        }
    }
}
