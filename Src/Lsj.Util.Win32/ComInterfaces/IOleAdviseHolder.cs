...
namespace Lsj.Util.Win32.ComInterfaces
{
    ...
    /// </para>
    /// <para>
    /// From: <see href="https://learn.microsoft.com/en-us/windows/win32/api/oleidl/nn-oleidl-ioleadviseholder"/>
    /// </para>
    /// </summary>
    public unsafe struct IOleAdviseHolder
    {
        ...
        /// For this method, the only relevant structure members are <see cref="STATDATA.pAdvSink"/> and <see cref="STATDATA.dwConnection"/>.
