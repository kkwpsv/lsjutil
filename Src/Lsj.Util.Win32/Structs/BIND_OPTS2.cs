...
namespace Lsj.Util.Win32.Structs
{
    ...
    /// </para>
    /// <para>
    /// From: <see href="https://learn.microsoft.com/en-us/windows/win32/api/objidl/ns-objidl-bind_opts2-r1"/>
    /// </para>
    /// </summary>
    /// <remarks>
    /// A <see cref="BIND_OPTS2"/> structure is stored in a bind context;
