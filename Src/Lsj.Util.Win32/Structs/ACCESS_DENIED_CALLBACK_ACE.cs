...
namespace Lsj.Util.Win32.Structs
{
    /// <summary>
    /// <para>
    /// The <see cref="ACCESS_DENIED_CALLBACK_ACE"/> structure defines an access control entry (ACE)
    ...
    /// in which a pointer to the <see cref="ACCESS_DENIED_CALLBACK_ACE"/> structure found is passed in the pAce parameter.
    /// </para>
    /// <para>
    /// From: <see href="https://learn.microsoft.com/en-us/windows/win32/api/winnt/ns-winnt-access_denied_callback_ace"/>
    /// </para>
    /// </summary>
    /// <remarks>
    ...
    /// When an <see cref="ACCESS_DENIED_CALLBACK_ACE"/> structure is created,
    ...
    public struct ACCESS_DENIED_CALLBACK_ACE
    {
        ...
        /// and the <see cref="ACE_HEADER.AceSize"/> member should be set to the total number of bytes allocated for the <see cref="ACCESS_DENIED_CALLBACK_ACE"/> structure.
        /// </summary>
