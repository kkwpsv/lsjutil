...
namespace Lsj.Util.Win32.BaseTypes
{
    /// <summary>
    /// <para>
    /// A <see cref="UINT32"/> is a 32-bit unsigned integer (range: 0 through 4294967295 decimal).
    /// Because a <see cref="UINT32"/> is unsigned, its first bit (Most Significant Bit (MSB)) is not reserved for signing.
    /// </para>
    /// <para>
