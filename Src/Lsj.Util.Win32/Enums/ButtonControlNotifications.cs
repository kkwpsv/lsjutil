...
namespace Lsj.Util.Win32.Enums
{
    ...
    public enum ButtonControlNotifications : uint
    {
        ...
        /// The parent window of the control receives this notification code in the form of a <see cref="WindowsMessages.WM_NOTIFY"/> message.
        /// </summary>
        ...
        /// The button control sends this notification code in the form of a <see cref="WindowsMessages.WM_NOTIFY"/> message.
        /// </summary>
        BCN_HOTITEMCHANGE = BCN_FIRST + 0x0001,

        /// <summary>
        /// Sent when the user clicks a button.
        /// The parent window of the button receives this notification code through the <see cref="WindowsMessages.WM_COMMAND"/> message.
        /// </summary>
        BN_CLICKED = 0,

        /// <summary>
        /// Sent when the user double-clicks a button.
        /// This notification code is sent automatically for <see cref="ButtonStyles.BS_USERBUTTON"/>, <see cref="ButtonStyles.BS_RADIOBUTTON"/>,
        /// and <see cref="ButtonStyles.BS_OWNERDRAW"/> buttons.
        /// Other button types send <see cref="BN_DBLCLK"/> only if they have the <see cref="ButtonStyles.BS_NOTIFY"/> style.
        /// The parent window of the button receives this notification code through the <see cref="WindowsMessages.WM_COMMAND"/> message.
        /// </summary>
        ...
        /// Applications should use the <see cref="ButtonStyles.BS_OWNERDRAW"/> button style and the <see cref="DRAWITEMSTRUCT"/> structure for this task.
        /// </remarks>
        BN_DISABLE = 4,
        ...
        /// This notification code is sent automatically for <see cref="ButtonStyles.BS_USERBUTTON"/>, <see cref="ButtonStyles.BS_RADIOBUTTON"/>,
        /// and <see cref="ButtonStyles.BS_OWNERDRAW"/> buttons.
        /// Other button types send <see cref="BN_DOUBLECLICKED"/> only if they have the <see cref="ButtonStyles.BS_NOTIFY"/> style.
        /// The parent window of the button receives this notification code through the <see cref="WindowsMessages.WM_COMMAND"/> message.
        /// </summary>
        BN_DOUBLECLICKED = 5,
        ...
        /// The button must have the <see cref="ButtonStyles.BS_NOTIFY"/> style to send this notification code.
        /// The parent window of the button receives this notification code through the <see cref="WindowsMessages.WM_COMMAND"/> message.
        /// </summary>
        BN_KILLFOCUS = 7,
