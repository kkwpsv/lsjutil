...
namespace Lsj.Util.Win32.Enums
{
    /// <summary>
    /// <para>
    /// To create an edit control using the <see cref="CreateWindow"/> or <see cref="CreateWindowEx"/> function, specify the EDIT class,
    /// appropriate window style constants, and a combination of the following edit control styles.
    /// After the control has been created, these styles cannot be modified, except as noted.
    /// </para>
    /// <para>
    /// From: <see href="https://learn.microsoft.com/en-us/windows/win32/controls/edit-control-styles"/>
    /// </para>
    /// </summary>
    [Flags]
