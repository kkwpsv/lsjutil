...
namespace Lsj.Util.Win32.Enums
{
    ...
    /// They are used for the dworigin parameter in the <see cref="IStream.Seek"/> method.
    /// The new seek position is calculated using this value and the dlibMove parameter.
    /// </para>
    /// <para>
    /// From: <see href="https://learn.microsoft.com/en-us/windows/win32/api/objidl/ne-objidl-stream_seek"/>
    /// </para>
    /// </summary>
