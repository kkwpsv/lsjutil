...
namespace Lsj.Util.Win32.NativeUI.Controls
{
    ...
    /// UpDown
    /// </summary>
    public class UpDown : BaseControl
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public UpDown(string text, int x, int y, int width, int height, UpDownControlStyles style, HWND parentWindow) : base("msctls_updown32", text, x, y, width, height, (uint)style, parentWindow)
        {
